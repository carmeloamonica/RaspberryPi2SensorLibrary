...
namespace SensitiveMicrophoneSensorModule
{
    /// <summary>
    ...
    public sealed partial class MainPage : Page
    {
        ...
        int _sensitiveMicrophoneSensorModule = 5; // define the tilt switch sensor interfaces
        ...
        {
            _gpio.InitGPIO(_sensitiveMicrophoneSensorModule, _led);
            SetSensor();
