...
namespace MercuryOpenOpticalModule
{
    /// <summary>
    ...
    public sealed partial class MainPage : Page
    {
        ...
        int _mercuryOpenOpticalModule = 5; // define the tilt switch sensor interfaces
        ...
        {
            _gpio.InitGPIO(_mercuryOpenOpticalModule, _led);
            SetSensor();
